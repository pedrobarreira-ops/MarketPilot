...
- 2026-04-18: Implementation complete. `apiClient.js` created. All 27 ATDD tests pass. 2 code-review patches applied during review: (1) transport-error catch block with `lastStatus = 0` sentinel, (2) `params ?? {}` null-guard. No deferred items.
